...
class PipelineDescription:
    ...
    description: dict[Callable, dict[str, list[Any] | Any]]
...
class PipelineManager:
    ...
    @classmethod
    def _resolve_complex_descriptions(cls, pipeline_description: PipelineDescription) -> list[PipelineDescription]:
        """
    ...
    @classmethod
    def run_search(cls, np_image: np.ndarray, search_strategy: str, ocr_engine: Optional[OcrEngine] = None,
                   cold_start=False):
...
class GridSearch(SearchStrategy):
    ...
    def search(self, np_image: np.ndarray):
        competitors = self.pipeline_manager.pipelines if self.cold_start else self.pipeline_manager.newly_added
...
class ImageSelector:
    ...
    _images: Optional[list[Any]] = None
    _image_indexes: Optional[list[int]] = None
    _current_batch_indexes: list[int] | None = None
